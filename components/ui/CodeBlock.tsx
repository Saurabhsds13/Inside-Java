...
export default function CodeBlock({
  ...
  const highlightJava = (line: string): string => {
    ...
    const tokenRegex = /(\/\/.*$)|(["'])(?:(?=(\\?))\3.)*?\2|(@\w+)|\b(public|private|protected|static|final|void|class|interface|extends|implements|new|return|if|else|for|while|do|try|catch|finally|throw|throws|import|package|this|super|null|true|false|instanceof|synchronized|volatile|abstract|native|transient|enum|record|sealed|permits|var|switch|case|default|break|continue|yield|when)\b|\b(int|long|double|float|boolean|byte|short|char|String|Object|Integer|Long|Double|Boolean|List|Map|Set|Array|ArrayList|HashMap|LinkedList|TreeMap|HashSet|Queue|Deque|Optional|Stream|Thread|Future|Callable|Runnable|Exception|RuntimeException|IOException|StringBuilder|StringBuffer|Comparable|Comparator|Iterable|Iterator|Collection|Serializable)\b|\b(\d+)\b/gm;
